import { CalendarDays, CirclePercent, CirclePlay, History, MapPin, Smartphone } from "lucide-react";
...
export default function CardInvestimento() {
  ...
  return (
    <div className="w-[270px] border border-rzk_ligth rounded-2xl">
      <h2 className="mt-2 mb-2 text-center text-lg font-extrabold text-rzk_darker">Investimento:</h2>
      <div className="w-32 flex flex-col space-y-2 m-auto text-rzk_regular">
        <div className="flex flex-col">
          ...
          <span className="font-extrabold text-rzk_green text-center">{resultados.investimento}</span>
        </div>
