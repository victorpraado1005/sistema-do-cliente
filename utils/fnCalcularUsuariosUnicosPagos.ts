...
// Função para chegar no valor final de usuários unicos de uma campanha Paga
// Essa função já retorna a soma e realiza o desconto de intersecção
export function fnCalcularUsuariosUnicosPagos(
